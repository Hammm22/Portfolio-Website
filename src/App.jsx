...
export default function App() {
  ...
  return (
      ...
      <div className="bg-primary relative w-full h-screen">
        ...
        <section className="h-screen w-full flex justify-center items-center bg-primary">
          <div className="h-2/3 w-2/3 grid grid-cols-3 md:grid-cols-7 grid-rows-3 md:grid-rows-6 gap-2 md:gap-4 m-4">
            ...
            <Card className="hidden md:block md:col-start-1 md:row-start-1 md:col-span-4 md:row-span-3 rounded-lg p-10 text-center">
    ...
    {Projects.map((data) => (
        <Card key={data.id} className='w-96 h-80 flex flex-col items-center justify-center p-4'>
            <h1 className='text-white text-2xl font-semibold'>Project {data.id}</h1>
